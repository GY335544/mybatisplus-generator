...
//       G:\git\agriculture_ecp\agriculture_n\agriculture\services\agriculture-producer-service\agriculture-producer-service-provider
        gc.setOutputDir("D:\\git\\cloud\\cloud\\cloud-common-transaction");  //provider工程路径
        gc.setModelOutDir("D:\\git\\cloud\\cloud\\cloud-common-transaction");  //entity工程路径
//        gc.setApiOutDir("D:\\git\\agriculture\\agriculture\\services\\agriculture-test\\api");  //api工程路径
        ...
        pc.setParent("com.ai");
        pc.setModuleName("transaction.message");
        ...
        strategy.setInclude(new String[] { "t_tx_deadletter"}); // 需要生成的表
