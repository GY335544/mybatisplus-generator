 ...
 * <p>Description: </p>  
 * @author gy  
 * @date 2018年8月27日 下午2:37:11  
 * @version 1.0
 */
public class TemplateConfig {

	private String model = ConstVal.TEMPLATE_MODEL_JAVA;
    ...
    public TemplateConfig setModel(String model) {
        this.model = model;
        return this;
    }
	...
	public String getModel(boolean kotlin) {
		return kotlin ? ConstVal.TEMPLATE_ENTITY_KT : model;
	}
