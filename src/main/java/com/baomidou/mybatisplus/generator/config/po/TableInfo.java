...
public class TableInfo {
    ...
    private List<String> importModelPackages = new ArrayList<String>();
    ...
    protected void setConvertModel(StrategyConfig strategyConfig) {
        if (strategyConfig.containsTablePrefix(name)) {
            // 包含前缀
            this.convert = true;
        } else if (strategyConfig.isCapitalModeNaming(name)) {
            ...
            } else if (!this.modelName.equalsIgnoreCase(name)) {
                this.convert = true;
            }
        }
    }
    ...
    public void setFields(List<TableField> fields) {
        if (CollectionUtils.isNotEmpty(fields)) {
            ...
            Set<String> entityPkgSet = new HashSet<String>();
            for (TableField field : fields) {
                if (null != field.getColumnType() && null != field.getColumnType().getPkg()) {
                    pkgSet.add(field.getColumnType().getPkg());
                    entityPkgSet.add(field.getColumnType().getPkg());
                }
                if (field.isKeyFlag()) {
                    // 主键
            ...
            if (!entityPkgSet.isEmpty()) {
                this.importModelPackages = new ArrayList<String>(Arrays.asList(entityPkgSet.toArray(new String[]{})));
            }
	...
	public void setModelName(StrategyConfig strategyConfig, String modelName) {
		this.modelName = modelName;
		 this.setConvertModel(strategyConfig);
	}
	...
	public void setImportModelPackages(List<String> importModelPackages) {
		this.importModelPackages = importModelPackages;
	}
