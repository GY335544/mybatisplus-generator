...
public abstract class AbstractTemplateEngine {
    ...
    public AbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
               ...
               // model.java
                String modelName = tableInfo.getEntityName();
                if (null != modelName&&template.getModel(false)!=null) {
                    String modelFile = String.format((pathInfo.get(ConstVal.MODEL_PATH) + File.separator + "%s" + this.suffixJavaOrKt()), modelName+"Model");
                    if (this.isCreate(modelFile)) {
                        this.writer(objectMap, this.templateFilePath(template.getModel(this.getConfigBuilder().getGlobalConfig().isKotlin())), modelFile);
                    }
                }
                // Mp.java
        	...
        	System.out.println("无法创建文件，请检查配置信息:"+e.getMessage());
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("model", tableInfo.getEntityName()+"Model");
